...
#d[, time := ifelse(time_of_day == '4 AM - 8 AM' | time_of_day == 'Midnight - 4 AM' | time_of_day == '8 PM - Midnight', '8 PM - 8 AM', '8AM - 8PM')]
#d[, music := ifelse(music_training == '1-2 years of training' | music_training == '3- 5 years of training', '1-5 years of training', music_training)]
d[,]
```
```{r}
...
```{r warning=FALSE}
m0 <- reg(d[,lm(score_improved ~ treatment + music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)])

m1 <- reg(d[age == '5 - 21 years',lm(score_improved ~  treatment +   music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)], ptest = FALSE)
m2 <- reg(d[age == '22 - 55 years' ,lm(score_improved ~  treatment + music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)], ptest = FALSE)
m3 <- reg(d[age == 'Older than 55 years' ,lm(score_improved ~  treatment + music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)], ptest = FALSE)
stargazer( m0$model, m1$model, m2$model, m3$model,
 type = 'html',
...
### without time_of_day treatment interaction
...
```{r warning=FALSE}
m0 <- reg(d[,lm(score_difference ~  treatment +  music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)])

m1 <- reg(d[age == '5 - 21 years',lm(score_difference ~  treatment +  music_training + time_of_day + treatment * time_of_day + gender + gender * treatment)], ptest = FALSE)
m2 <- reg(d[age == '22 - 55 years' ,lm(score_difference ~  treatment +  music_training + time_of_day + treatment * time_of_day + gender + gender * treatment )], ptest = FALSE)
m3 <- reg(d[age == 'Older than 55 years' ,lm(score_difference ~  treatment +  music_training + time_of_day + treatment * time_of_day + gender + gender * treatment )], ptest = FALSE)
stargazer( m0$model, m1$model, m2$model, m3$model,
 type = 'html',
 title = 'Long Model - Score Improved',
 se = list(sqrt(diag(vcovHC(m0$model, type="HC1"))),
...
### w.o interaction on time of day
